...
export default async function Page({
    ...
    const [marketAndExchangeName, contractSet] = contractsTree.getContractSet(
            ...
            <div>
                <div>
                    ...
                    <ul className="space-y-5">
                        {contractSet &&
                            contractSet[CFTCReportType.FinancialFutures]
                                ?.length > 0 && (
                        ...
                        {contractSet &&
                            contractSet[CFTCReportType.Disaggregated]?.length >
                                0 && (
                                <li className="list-disc">
                                    <Link
                                        className="text-blue-500 hover:text-blue-700"
                        ...
                        {contractSet &&
                            contractSet[CFTCReportType.Legacy]?.length > 0 && (
                                <li className="list-disc">
                                    <Link
                                        className="text-blue-500 hover:text-blue-700"
...
export async function generateStaticParams({
    ...
    let res = contractsTree.selectTree({}, [
        'group',
