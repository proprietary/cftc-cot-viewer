...
export default function Tff({ contract }: { contract: CommodityContractKind }) {
    const [reports, setReports] = React.useState<
        Array<IFinancialFuturesCOTReport>
    >([])
                    ...
                    plottedColumns={[
                        {
                            ...
                            data: reports.map(
                                (x) =>
                                    (x.dealer_positions_long_all -
                                        x.dealer_positions_short_all) /
                                    x.open_interest_all
                            ),
                        },
                        {
                            ...
                            data: reports.map(
                                (x) =>
                                    (x.asset_mgr_positions_long -
                                        x.asset_mgr_positions_short) /
                                    x.open_interest_all
                            ),
                        },
                        {
                            ...
                            data: reports.map(
                                (x) =>
                                    (x.lev_money_positions_long -
                                        x.lev_money_positions_short) /
                                    x.open_interest_all
                            ),
                        },
                        {
            ...
            <div className="my-2 min-h-screen">
                ...
                <LongShortOIChart
                    ...
                    shortCols={[
                        {
                            name: 'Dealers',
                            column: 'dealer_positions_short_all',
                        },
                        {
                            name: 'Asset Managers',
                            column: 'asset_mgr_positions_short',
                        },
                        {
                            name: 'Leveraged Funds',
                            column: 'lev_money_positions_short',
                        },
                        {
                            name: 'Other Reportables',
